<template>
  <section id="Benefits" href="Benefits">
    <div class="content">
    ...
    <article>
      <p>
        The biggest feature of Git is it's branching and merging capabilities. Branching means you create a pointer to a snapshot of your changes while you work on a new feature without impacting the main branch (master). When you're done working on your feature, you can geniusly merge back your changes in the main branch.<br>
        Of course sometimes you'll have to work jointly with a teammate on a feature. That's when you'll probably encounter merge conflicts.<br><br>
      </p>
      <p>
