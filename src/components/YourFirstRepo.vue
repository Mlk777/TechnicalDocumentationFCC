<template>
  <section id="YourFirstRepo" href="YourFirstRepo">
    <div class="content">
    ...
    <article>
      <p>
        ...
        <code>
          git clone "link you copied" "folder to clone into" <br><br>
           <u>&nbsp;Example </u>: git clone https://github.com/Mlk777/test.git TestRepository
        </code>
        <br>
      </p>
      <p>
